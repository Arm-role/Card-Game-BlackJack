...
export class Room {
  ...
  public getHostId(): number | undefined { return this.seatManager.getHostId(); }
  public isHost(playerId: number): boolean { return this.seatManager.isHost(playerId); }
  ...
  public canStartGame(playerId: number): boolean {
    return this.seatManager.getPlayerCount() >= 1 && this.seatManager.isHost(playerId);
  }
